...
<div class="position-relative overflow-hidden p-1 p-md-1 m-md-1 text-center bg-light" id="con">
    <div class="col-md-5 p-lg-8 mx-auto my-3">
    <img src="images/2.jpg" width="300" alt="">
      <h1 class="display-9 fw-normal">اربح مع عبد المجيد</h1>
...
<!--
 ...
 <div class="loader-con">
    <div id="loader">
	    <canvas id="circularLoader" width="40" height="40"></canvas>
    </div>
</div>
...
<div class="d-grid gap-2 col-3 mx-auto my-10">
